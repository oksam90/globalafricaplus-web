    ...
    <div v-else>
        ...
        <section class="bg-gradient-to-br from-sky-50 via-blue-50 to-slate-50 dark:from-sky-950/40 dark:via-blue-950/30 dark:to-slate-900 border-b border-slate-100 dark:border-slate-700">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <span v-if="call.sector" class="text-xs px-2 py-0.5 rounded-full bg-sky-50 text-sky-700 font-medium">{{ call.sector }}</span>
                    <span class="px-1.5 py-0.5 rounded bg-sky-100 text-sky-700 text-[10px] font-bold">Officiel</span>
                </div>
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-5">
                    <!-- Apply CTA -->
                    <div v-if="call.status === 'open' && !isExpired" class="bg-sky-50 border border-sky-100 rounded-2xl p-5">
                        ...
                        <template v-if="auth.isAuthenticated">
                            ...
                            <p v-else class="text-sm text-emerald-700 font-semibold">✓ Vous avez déjà candidaté.</p>
                        </template>
