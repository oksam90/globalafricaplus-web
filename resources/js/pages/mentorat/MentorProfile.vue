<template>
    ...
    <div v-else>
        ...
        <!-- Request modal -->
        <Modal v-model="showRequestModal" size="lg"
            :title="`Demander un mentorat à ${mentor?.name || ''}`">
            <form id="mentor-request-form" @submit.prevent="submitRequest" class="space-y-4">
                    <div>
            ...
            <template #footer="{ close }">
                ...
                <button type="submit" form="mentor-request-form" :disabled="requestLoading"
                    class="px-5 py-2.5 rounded-md bg-violet-600 hover:bg-violet-700 text-white font-semibold disabled:opacity-50">
